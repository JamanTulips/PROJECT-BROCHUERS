...
const logoRows = [
  [
    { src: "/img/grandeinternational.jpeg", alt: "Grande International Hospital logo" },
  ...
  [
    ...
    { src: "/img/purbancalcancer.jpeg", alt: "Purbanchal Cancer Hospital logo" },
  ...
  [
    ...
    { src: "/img/kathmandumedical.jpeg", alt: "Kathmandu Medical College logo" },
    { src: "/img/nobelmedical.jpeg", alt: "Nobel Medical College logo" },
    { src: "/img/dhakamedical.jpeg", alt: "Dhaka Medical College Hospital logo" },
  ],
];

export default function ClinicalNetwork() {
  return (
    <section className={styles.section} aria-labelledby="clinical-network-title">
      <div className={styles.networkPanel}>
        <div className={styles.header}>
          <h2 id="clinical-network-title">Our Clinical Network</h2>
          <p>Trusted by the leading hospitals and medical institution across Nepal and Bangladesh</p>
        </div>

        <div className={styles.logoGrid} aria-label="Clinical network hospital logos">
          {logoRows.map((row, rowIndex) => (
            <div className={styles.logoRow} key={`clinical-network-row-${rowIndex}`}>
              {row.map((logo) => (
